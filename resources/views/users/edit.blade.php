    ...
    <div class="card" style="margin:20px;">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('user/' .$users->id) }}" method="post">
                ...
                <input type="email" name="email" id="address" value="{{$users->email}}" class="form-control"></br>
                <label>Password</label></br>
                <input type="password" name="password" id="mobile" value="{{$users->password}}" class="form-control"></br>
                <label>Role</label></br>
